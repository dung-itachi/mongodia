...
X�y d?ng Sales Dashboard d?c ho�n to�n t? MongoDB.
...
| File | M� t? |
| ---- | --------- |
| src/repositories/sales-dashboard.repository.ts | SalesDashboardRepository v?i c�c aggregation pipelines |
...
| File | Thay d?i |
| ---- | --------- |
| src/constants/permissions.ts | Th�m sales.dashboard.view permission |
| src/constants/roles.ts | Th�m sales.dashboard.view cho SALE role |
...
| Card | Icon | Format |
| ---- | ---- | ------ |
| Doanh thu h�m nay | ?? | currency |
| Doanh thu th�ng | ?? | currency |
| �on h�ng h�m nay | ?? | number |
| �on h�ng th�ng | ?? | number |
| Kh�ch h�ng m?i | ?? | number |
| KH dang cham s�c | ?? | number |
| Follow-up h�m nay | ?? | number |
| Follow-up qu� h?n | ?? | number |
...
| Top kh�ch h�ng | Top sales by customer count |
